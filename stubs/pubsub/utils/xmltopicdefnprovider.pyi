...
__all__ = ['XmlTopicDefnProvider', 'exportTopicTreeSpecXml', 'TOPIC_TREE_FROM_FILE']
...
def exportTopicTreeSpecXml(moduleName=None, rootTopic=None, bak: str = 'bak', moduleDoc=None): ...
